    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('tool', 'Tool'), ('material', 'Material')], max_length=50, null=True)),
                ('stored_quantity', models.PositiveIntegerField(null=True)),
                ('quantity_in_use', models.PositiveIntegerField(null=True)),
